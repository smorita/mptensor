...
void pdsygvx_(int *ibtype, char *jobz, char *range, char *uplo, int *n,
              ...
              int *lwork, int iwork[], int *liwork, int ifail[], int iclustr[],
              double gap[], int *info);
...
void pzgemm_(char *transa, char *transb, int *m, int *n, int *k, complex *alpha,
             ...
             int descc[]);
void pzgesvd_(char *jobu, char *jobvt, int *m, int *n, complex a[], int *ia,
              int *ja, int desca[], double s[], complex u[], int *iu, int *ju,
              int descu[], complex vt[], int *ivt, int *jvt, int descvt[],
              complex work[], int *lwork, double rwork[], int *info);
void pzheev_(char *jobz, char *uplo, int *n, complex a[], int *ia, int *ja,
             int desca[], double w[], complex z[], int *iz, int *jz,
             int descz[], complex work[], int *lwork, double rwork[],
             int *lrwork, int *info);
void pzhegvx_(int *ibtype, char *jobz, char *range, char *uplo, int *n,
              complex a[], int *ia, int *ja, int desca[], complex b[], int *ib,
              int *jb, int descb[], double *vl, double *vu, int *il, int *iu,
              double *abstol, int *m, int *nz, double w[], double *orfac,
              complex z[], int *iz, int *jz, int descz[], complex work[],
...
void pzungqr_(int *m, int *n, int *k, complex a[], int *ia, int *ja,
              int desca[], complex tau[], complex work[], int *lwork,
              int *info);
...
void matrix_product(const Matrix<double> &A, const Matrix<double> &B,
  ...
  pdgemm_(&transa, &transb, &M, &N, &K, &alpha, const_cast<double *>(A.head()),
          &ia, &ja, const_cast<int *>(A.descriptor()),
          const_cast<double *>(B.head()), &ib, &jb,
          const_cast<int *>(B.descriptor()), &beta, C.head(), &ic, &jc,
          const_cast<int *>(C.descriptor()));
};
...
void matrix_product(const Matrix<complex> &A, const Matrix<complex> &B,
  ...
  pzgemm_(&transa, &transb, &M, &N, &K, &alpha, const_cast<complex *>(A.head()),
          &ia, &ja, const_cast<int *>(A.descriptor()),
          const_cast<complex *>(B.head()), &ib, &jb,
          const_cast<int *>(B.descriptor()), &beta, C.head(), &ic, &jc,
          const_cast<int *>(C.descriptor()));
};
